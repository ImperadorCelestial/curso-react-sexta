  ...
  return (
   <div className="cont-app">
    ...
    <div className="cap00 capitulos">
      ...
      <button className='capitulos_button' onClick={() => setCapitulo01(true)}>Iniciar Jogo</button>
    </div>
    ...
    {capitulo01 &&
      <div className="cap01 capitulos">
        ...
        <button className='capitulos_button' onClick={() => setCapitulo02(true)}>Falar a verdade</button>
        <button className='capitulos_button' onClick={() => setCapitulo03(true)}>Mentir</button>
      </div>    
    }
...

    {
      ...
      <div className="cap02 capitulos">
        ...
        <button className='capitulos_button' onClick={() => setCapitulo04(true)}>Aceitar</button>
        <button className='capitulos_button' onClick={() => setCapitulo05(true)}>Rejeitar</button>
      </div>
    }
...

    {
      ...
      <div className="cap03 capitulos">

        <h2>03: Mentir; Lucio Fernando</h2>
        <p>
          Roque mente para as Tias Fofinhas que tem as toalhas. Elas perguntam de que cor são, ele diz que são brancas (afinal todas as toalhas de crochê são brancas, não é?). Elas complementam que suas toalhas tem que ser pretas. Ele gagueja, diz que se enganou e que elas são pretas.
        ...
        <button className='capitulos_button' onClick={() => setCapitulo07(true)}>Sim</button>
        <button className='capitulos_button' onClick={() => setCapitulo06(true)}>Não</button>
      </div>
    }
...

    {
      ...
      <div className="cap04 capitulos">
        ...
        <button className='capitulos_button' onClick={() => setCapitulo08(true)}>Sim</button>
        <button className='capitulos_button' onClick={() => setCapitulo09(true)}>Não</button>
      </div>
    }
...

    {
      ...
      <div className="cap08 capitulos">
        ...
        <button className='capitulos_button' onClick={() => setCapitulo10(true)}>Sim</button>
        <button className='capitulos_button' onClick={() => setCapitulo11(true)}>Não</button>
      </div>
    }
